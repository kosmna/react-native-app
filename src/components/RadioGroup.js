            ...
            >
              ...
              {underline && isActive && (
                <View
                  style={{
                    height: 5,
                    borderBottomColor: colors.radio_primary_color,
                    borderBottomWidth: 3,
                    position: 'absolute',
                  }}
                />
...
const styles = {
  container: {
    flex: 1,
    flexDirection: 'row',
    borderColor: colors.radio_primary_color,
    borderWidth: 1,
    borderRadius: 5,
  },
  underline: {
  ...
  itemActive: {
    backgroundColor: colors.radio_primary_color,
  },
  itemActiveUnderline: {
    borderBottomWidth: 2,
    borderBottomColor: colors.radio_primary_color,
  ...
  textActiveUnderline: {
    color: colors.radio_primary_color,
  },
};
